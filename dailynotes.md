...
>> memblock_init()
>> performs memblock regiestering and initrd placement
...
There may be a need to check again how the system is supposed to poweroff.[ 90.891143] SysRq : Emergency Remount R/O
